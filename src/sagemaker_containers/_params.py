...
TRAIN_DIR_ENV = 'SAGEMAKER_TRAIN_SUBMIT_DIRECTORY'  # type: str
SERVE_DIR_ENV = 'SAGEMAKER_SERVE_SUBMIT_DIRECTORY'  # type: str
TRAIN_USER_PROGRAM_ENV = 'SAGEMAKER_TRAIN_PROGRAM'  # type: str
SERVE_USER_PROGRAM_ENV = 'SAGEMAKER_SERVE_PROGRAM'  # type: str
