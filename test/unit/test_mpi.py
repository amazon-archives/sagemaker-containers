...
#     """Unit test for ``_create_mpi_program``, to verify the script is generated in the valid format.
#     """
#
#     mpi_script_path = "/tmp/mpi_script.sh"
#     _mpi._create_mpi_program(args=["--sample", "arg1", "--sample2", "1"], train_script="train.py",
...
#
#         mpi_worker = MPIWorker(current_host="algo-1")
#         mpi_worker._wait_master_to_finish()
#
#         mock_isfile.assert_has_calls(
...
# @patch('sagemaker_containers._mpi._create_mpi_program', autospec=True)
...
# def test_mpi_run_for_master(mock_master, _create_mpi_program, _setup_mpi_environment, mock_env_generator, train_script,
...
#     _create_mpi_program.assert_called_with(args, train_script, code_dir, _mpi._MPI_SCRIPT,
...
# @patch('sagemaker_containers.training_env')
# @patch('sagemaker_containers._mpi._setup_mpi_environment')
# @patch('sagemaker_containers._mpi._create_mpi_program')
...
#                           ("train.py", "/opt/ml/code", ["--sample", "arg1"], {"SM_SAMPLE": "VAL1"}, False, False),
#                           ("train.py", "/opt/ml/code", ["--sample", "arg1"], {"SM_SAMPLE": "VAL1"}, False, True)])
# def test_mpi_run_for_worker(mock_is_master, mock_worker, mock_master, _create_mpi_program, _setup_mpi_environment,
#                             mock_env_generator,
